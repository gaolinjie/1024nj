<header class="slidePanel-header overlay" style="background-image: url('/static/admin/remark/photos/placeholder.png');"
...
<div class="slidePanel-inner">
  ...
  <section class="slidePanel-inner-section">
    <div class="media-header">
      ...
      <a class="avatar margin-right-10" href="javascript:void(0)">
        <img src="/static/admin/remark/portraits/2.jpg" alt="...">
      </a>
  ...
  <div class="slidePanel-comment">
    <textarea class="maxlength-textarea form-control mb-sm" rows="4" disabled></textarea>
    <div class="reply"><a href="javascript:void(0)">Reply</a> or <a href="javascript:void(0)">Forward</a></div>
  </div>
</div>