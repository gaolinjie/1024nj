  ...
  window.AppProjects = App.extend({
    handleSelective: function() {
      var members = [{
          id: 'uid_1',
          name: 'Herman Beck',
          img: '/static/admin/remark/portraits/1.jpg'
        }, {
          id: 'uid_2',
          name: 'Mary Adams',
          img: '/static/admin/remark/portraits/2.jpg'
        }, {
          id: 'uid_3',
          name: 'Caleb Richards',
          img: '/static/admin/remark/portraits/3.jpg'
        }, {
          id: 'uid_4',
          name: 'June Lane',
          img: '/static/admin/remark/portraits/4.jpg'
        }],
        selected = [{
          id: 'uid_1',
          name: 'Herman Beck',
